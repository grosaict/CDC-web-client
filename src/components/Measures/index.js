...
export default function Measures(props) {
    ...
    let lengthChartData = chartData;
    let headChartData   = chartData;

    const setWeightChart = (k) => {

        let paramTitle = ( k.gender === 'F' ? 'Gráfico de peso para meninas de 0 a 2 anos' : 'Gráfico de peso para meninos de 0 a 2 anos' )
